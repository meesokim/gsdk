...
gbdk-install: maccer-install sdcc-install gbdk-support-install gbdk-lib-install 
...
maccer-install:
	$(MAKE) -C $(MACCERDIR) install BUILDDIR=$(BUILDDIR)
